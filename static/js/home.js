...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('/datos-json')
        ...
        .then(data => {
            ...
            if (labels.length == 0) {
                document.getElementById("graficopastel").innerHTML = "<h2>No hay datos para mostrar</h2>";
            }
            else {
            ...
            if (categorias.length == 0) {
                document.getElementById("graficobarra").innerHTML = "<h2>No hay datos para mostrar</h2>";
            }
            else{
